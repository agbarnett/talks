...
# .center[“No country bureaucratized its way to excellence”, how unnecessary ethics and governance requirements are holding back research in Australia]

## .center[Adrian Barnett, QUT; Anna Scott, Bond;<br>Natalie Taylor, NSWCC; Jeniffer Byrne, Sydney]
...
---
background-image: url(figures/trust.jpg)
# Data linkage

* "While there is strong protection against risks to privacy and multiple avenues of redress, there is no redress where harms result from a failure to release data for research." [Allen et&nbsp;al](https://pubmed.ncbi.nlm.nih.gov/24597394/)

* Data custodians may fear becoming a scapegoat if something goes wrong


###### Image from Marco Verch, flickr.com
...
---
## UQ bus study, Redzo Mujcic and Paul Frijters

```{r, out.width='60%'}
knitr::include_graphics(path='figures/uq_bus_study.png')
```

--

* White testers were accepted during 72% of the interactions versus only 36% for black testers
...
---
background-image: url(figures/brain_surgery.jpg)


###### Image from Domiriel, flickr.com
...
* Audio version [here](https://osf.io/yefv8/)
...
* "It’s time for this benighted country to catch up and begin to rein in these out-of-control ethics committees"
...
* "Critical issue because these delays are slowing, and in some cases stopping, research. This comprises Australia's ability to provide world class healthcare"
...
* Vanessa Constable led a project to reduce repeated site-specific assessment at Metro North Hospital and Health Service

* Average number of SSAs saved per year = 171; total costs saved = $49,000
...
* Would a one-day meeting be useful?
