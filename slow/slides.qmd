---
title: "Slowing down to speed scientific progress"
author: Adrian Barnett<br>4 November 2026
...
HAVE NOT DONE ANYTHING YET, see abstract in readme.

Only 15 mins

Start with 2% guy

Talk about how many breakthroughs you can expect?

Could talk about white text instructions.

Talk about AI and how we could use it to encourage reproducible research.
...
<small>Thank you for providing information to support your complaint. As part of our investigation, we may need to share this information with the authors of the publication, their institution or other organizations.</small>  
...
::: {.column width="60%"}
![](figures/F2.large.jpg){.absolute top="20"
right="20"}
:::
::::
...
* With Matt Spick (Surrey), we created a paper using _Prism_ (_OpenAI_) in 30 minutes with no human input
...
* For NHMRC money only, this would mean $740 million per year on quality-related work
...
<img width="960" alt="Oiled diving duck" src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/df/Oiled_diving_duck.JPG/960px-Oiled_diving_duck.JPG?utm_source=commons.wikimedia.org&utm_campaign=index&utm_content=thumbnail">
