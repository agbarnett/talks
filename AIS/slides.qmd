...
* An observational study of 19,000+ people compared people who downloaded the _Pokémon Go_ app with people who downloaded cooking apps and examined their physical activity for the next seven days

* People who downloaded _Pokémon Go_:
   + more often met the physical activity guidelines: 22.4% versus 20.4% (p $<$ 0.002)
   + had improved quality of life: 0.86 versus 0.84 on the 0-to-1 scale
(p $<$ 0.001)

* Do you think the results are real? Are they important? Is there anything wrong with the study design?
...
* Ideal analysis is to use follow-up time as the dependent variable and the baseline as an independent variable (known as "Analysis of covariance")

* Best not to use change as the dependent variable

* Works best when dependent variable is continuous, so be careful with ordinal variables, e.g., pain score of 1 to 5
