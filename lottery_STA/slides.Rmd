...
.pull-left[
* Problems with traditional funding schemes
* How a lottery system can help
* Who is using a lottery system
* How to use a lottery system
* Questions

]

.pull-right[
![](https://media.giphy.com/media/JUNKPoNsn8hcS7IpGs/giphy.gif)
]
...
---
# Put names in Excel spreadsheet

```{r, out.width='74%'}
knitr::include_graphics(path='figures/excel_1.jpg')
```
...
```{r, out.width='74%'}
knitr::include_graphics(path='figures/excel_2.jpg')
```

---
# Copy function to all eligible people

```{r, out.width='74%'}
knitr::include_graphics(path='figures/excel_3.jpg')
```

---
# Copy column and paste to another column using values

```{r, out.width='74%'}
knitr::include_graphics(path='figures/excel_4.jpg')
```

---
# Delete original random column

```{r, out.width='74%'}
knitr::include_graphics(path='figures/excel_5.jpg')
```
...
```{r, out.width='101%'}
knitr::include_graphics(path='figures/excel_6.jpg')
```
...
```{r, out.width='74%'}
knitr::include_graphics(path='figures/excel_6b.jpg')
```
...
```{r, out.width='74%'}
knitr::include_graphics(path='figures/excel_7.jpg')
```
...
---
# Example email to applicants

.pull-left[

### "Thank you for your application to the Amazing Scientist scheme. Your application was judged as meritorious, but was not selected using the lottery process. There were 10 eligible applications and 4 were randomly selected to receive funding. We hope you will consider applying in future rounds."

]

.pull.right[

![](https://media.giphy.com/media/2wWBH0vXsVUmKtRJOe/giphy.gif)
...
[Blog](https://www.statnews.com/2022/10/21/research-funding-broken-lottery-approach-could-fix-it/) on using lotteries in research

[Scientific paper](https://www.sciencedirect.com/science/article/pii/S0039368118300190) on using lotteries

[Nature article](https://www.nature.com/articles/d41586-021-01232-3) on using lotteries

[New York Times article](https://www.nytimes.com/2020/02/14/science/research-funding-lotteries.html) on using lotteries

<!--- [](Explanation) from Swiss National Science Foundation on why they are using 
lotteries --->
