...
#### https://www.menti.com/v7z29zhuba

#### Go to www.menti.com and use the code 1728 3788
...
c) of obtaining the observed or more extreme results if the alternative hypothesis is true

d) of obtaining the observed results or results which are more extreme if the null hypothesis is true

e) that the results happened by chance
...
Z-values extracted from _Medline_ between 1976 and 2019
...
### Randomly audit 50 papers per year from each university & research institute
...
.pull-right[
![](https://media.giphy.com/media/l1TRyTtoIfV8hnmOA3/giphy.gif)
